...
class Circle(FCNNodeModel):
    ...
    def __init__(self, scene):
        super().__init__(scene=scene,
                         inputs_init_list=[("R", True, ), ("Pos", True, ), ("Dir", True, )],
    ...
    def eval_operation(self, sockets_input_data: list) -> list:
        ...
        r_pos_dir_zip: list = ak.zip([radius, pos_idx_list, dir_idx_list], depth_limit=None).tolist()

        return [map_objects(r_pos_dir_zip, tuple, self.make_occ_circle)]
