...
class Context(object):
    ...
    def outSite(self, s):
        if (self.debug):
            print
            "site (%d) at %f %f" % (s.sitenum, s.x, s.y)
    ...
    def outVertex(self, s):
        ...
        if (self.debug):
            print
            "vertex(%d) at %f %f" % (s.sitenum, s.x, s.y)
        elif (self.triangulate):
            pass
    ...
    def outTriple(self, s1, s2, s3):
        ...
        if (self.debug):
            ...
            print
            "%d %d %d" % (s1.sitenum, s2.sitenum, s3.sitenum)
...
class Edge(object):
    ...
    def dump(self):
        print
        "(#%d a=%g, b=%g, c=%g)" % (self.edgenum, self.a, self.b, self.c)
        print
        "ep", self.ep
        print
        "reg", self.reg
